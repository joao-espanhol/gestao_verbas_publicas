...
void menu_03(){
    ...
    while(sair != 0){
        ...
        printf("\n1 – RH ------------------------------------------ Valor Gasto: %i ----- Valor Disponível: %i\n", gasto_rh, disponivel_rh);
        printf("\n2 – Encargos Sociais ------------------------ Valor Gasto:%i ----- Valor Disponível: %i\n", gasto_esociais, disponivel_esociais);
        printf("\n3 – Fundo Reserva -------------------------- Valor Gasto:%i ----- Valor Disponível: %i\n", gasto_fundo,disponivel_fundo);
        printf("\n4 - Alimentação ----------------------------- Valor Gasto:%i ----- Valor Disponível: %i\n", gasto_alimentacao, disponivel_alimentacao);
        printf("\n5 – Material Pedagógico ------------------ Valor Gasto: %i ----- Valor Disponível:%i\n", gasto_pedagogico, disponivel_pedagogico);
        printf("\n6 – Concessionária ------------------------- Valor Gasto: %i ----- Valor Disponível:%i\n",gasto_concessionaria, disponivel_concessionaria);
        printf("\n7 – Oficineiro -------------------------------- Valor Gasto: %i ----- Valor Disponível: %i\n", gasto_oficineiro, disponivel_oficineiro);
        printf("\n8 – Outras Despesas ----------------------- Valor Gasto:%i ----- Valor Disponível:%i\n", gasto_outros, disponivel_outros);
        printf("\nPara sair, digite 0\n");
        scanf("%i", &sair);
        system("cls");
    }
